...
import { Home, Search, DollarSign, Star } from 'lucide-react';
  ...
  return (
    <TenantLayout>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold">Tenant Dashboard</h2>
          <p className="text-muted-foreground">Your properties and payment status</p>
        </div>
        <Button onClick={() => navigate('/tenant/join')} size="lg" className="w-full md:w-auto">
